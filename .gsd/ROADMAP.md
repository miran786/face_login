...
- [ ] Next.js (React) front-end structure built
...
**Status**: ⬜ Not Started
**Objective**: Scaffold the Next.js frontend, the Node.js/Express backend, and configure the database connection. Start defining models.
