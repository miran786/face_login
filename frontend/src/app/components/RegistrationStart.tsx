...
export function RegistrationStart({ onStartFaceID, onUseTraditional, onFaceLogin, onLogin }: RegistrationStartProps) {
  return (
        ...
        >
          <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-8 shadow-2xl mb-4">
            ...
            <Button
              ...
              className="w-full bg-white text-purple-600 hover:bg-purple-50 py-6 rounded-2xl text-lg font-semibold shadow-xl mb-3"
            >
              <Scan className="mr-2" />
            ...
            <Button
              onClick={onFaceLogin}
              variant="outline"
              className="w-full border-white/30 text-white hover:bg-white/10 py-6 rounded-2xl text-lg bg-white/5 backdrop-blur-xl"
            >
              <Lock className="mr-2" />
              Login with Face ID
            </Button>
